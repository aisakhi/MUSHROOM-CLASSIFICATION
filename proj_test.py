...
def parse_data(fname):
    ...
    data_file = 'err.txt'
    if fname == 'mushroom_training.txt':
        data_file = 'training_err.txt'
    elif fname == 'mushroom_testing.txt':
...
if __name__ == '__main__':
    ...
    parse_data('mushroom_testing.txt')
